...
class Visita(models.Model):
    ...
    operador_entrada     = models.ForeignKey(Usuario, models.DO_NOTHING, db_column='operador_entrada_id', related_name='visitas_registradas', null=True, blank=True)
    operador_salida      = models.ForeignKey(Usuario, models.DO_NOTHING, db_column='operador_salida_id', related_name='visitas_cerradas', null=True, blank=True)
